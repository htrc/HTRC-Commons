...
import edu.indiana.d2i.htrc.usermgt.exceptions.ChangePasswordUserAdminExceptionException;
import edu.indiana.d2i.htrc.usermgt.exceptions.UserAlreadyExistsException;
...
public class UserManagementUtil {
    ...
    public static UserManagementUtil getInstanceWithDefaultProperties(String oauthBackendUrl, String userRegURL, String userRegUser, String userRegPwd) {
        try {
            ...
            return new UserManagementUtil(
                    oauthBackendUrl + "/services/",
                    userRegURL,
                    userRegUser,
                    userRegPwd,
                    userMgtUtilityProps);
    ...
    public UserManagementUtil(String isURL, String gregURL, String userName, String password,
                                  Properties configProperties) {
        if (!(configProperties.containsKey(Constants.UR_CONFIG_HTRC_USER_HOME)
                && configProperties.containsKey(Constants.UR_CONFIG_HTRC_USER_FILES)
                && configProperties.containsKey(Constants.UR_CONFIG_HTRC_USER_WORKSETS)
                && configProperties.containsKey(Constants.UR_CONFIG_HTRC_USER_JOBS))) {
...
//            }
            ...
            String regUserHome = String.format(configProperties.getProperty(Constants.UR_CONFIG_HTRC_USER_HOME), userName);
            String regUserFiles = String.format(configProperties.getProperty(Constants.UR_CONFIG_HTRC_USER_FILES),
                    userName);
            String regUserWorksets = String.format(configProperties.getProperty(Constants.UR_CONFIG_HTRC_USER_WORKSETS),
                    userName);
            String regUserJobs = String.format(configProperties.getProperty(Constants.UR_CONFIG_HTRC_USER_JOBS), userName);
